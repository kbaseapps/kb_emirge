...
function kb_emirge(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_emirge = function (input_params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_emirge.run_emirge",
            [input_params], 1, _callback, _errorCallback);
    };
 
     this.exec_emirge = function (input_params, _callback, _errorCallback) {
        if (typeof input_params === 'function')
            throw 'Argument input_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_emirge.exec_emirge",
            [input_params], 1, _callback, _errorCallback);
    };
 
     this.exec_emirge_SingleLibrary = function (input_params, _callback, _errorCallback) {
        if (typeof input_params === 'function')
            throw 'Argument input_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_emirge.exec_emirge_SingleLibrary",
            [input_params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_emirge.status",
